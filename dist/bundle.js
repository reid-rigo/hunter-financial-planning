...
var HFP = (() => {
  ...
  var MAX_SAFE_INTEGER, MAX_ARRAY_LENGTH, nativeMin, times_default;
  ...
  __export(calculator_exports, {
    calculateLifePlan: () => calculateLifePlan
  });
  function calculateLifePlan(lifePlan) {
    const { initialAmount, monthlyContribution, growthRate, startYear, years } = lifePlan;
    const yearPlans = times_default(years + 1, (y) => {
      return { monthlyContribution, growthRate, year: startYear + y };
    });
    let amount = initialAmount;
    const calculatedYearPlans = yearPlans.map((yearPlan) => {
      const { monthlyContribution: monthlyContribution2, growthRate: growthRate2 } = yearPlan;
      const initialAmount2 = amount;
      const finalAmount = amount * (1 + growthRate2 / 100) + monthlyContribution2 * 12;
      amount = finalAmount;
      return __spreadProps(__spreadValues({}, yearPlan), {
        initialAmount: initialAmount2,
        finalAmount
      });
    });
    return __spreadProps(__spreadValues({}, lifePlan), {
      calculatedYearPlans,
      finalAmount: amount
    });
  }
  ...
  var init_helpers_segment = __esm({
    "node_modules/chart.js/dist/chunks/helpers.segment.js"() {
      ...
      TAU = 2 * PI;
      PITAU = TAU + PI;
      INFINITY2 = Number.POSITIVE_INFINITY;
      RAD_PER_DEG = PI / 180;
      HALF_PI = PI / 2;
      QUARTER_PI = PI / 4;
  ...
  var init_chart = __esm({
    "node_modules/chart.js/dist/chart.js"() {
      ...
      hasFunction = (value) => isObject2(value) && Object.getOwnPropertyNames(value).reduce((acc, key) => acc || isFunction(value[key]), false);
      version = "4.2.1";
      KNOWN_POSITIONS = [
        "top",
        "bottom",
  ...
  __export(chart_exports, {
    chartLifePlan: () => chartLifePlan
  });
  function chartLifePlan(canvas, lifeResult) {
  ...
  __export(form_exports, {
    ...
    formatPercentageInput: () => formatPercentageInput,
    onLifePlanUpdate: () => onLifePlanUpdate
  });
  ...
  function numberFromInputSelector(form, selector) {
